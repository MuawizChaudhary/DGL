...
import os
import wandb
from models import similarity_matrix, LocalLossBlockLinear, LocalLossBlockConv
...
def loss_calc(outputs, y, y_onehot, module, loss_sup, beta, no_similarity_std):
    if isinstance(module, LocalLossBlockLinear) or isinstance(module, LocalLossBlockConv) and type(outputs) == tuple:
